...
namespace RandomVariables
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var uniformVariable = new RandomVariable(new UniformDistribution { A = 0, B = 1 });

            Console.WriteLine("\nРавномерное распределение");
            Console.WriteLine($"{uniformVariable.SummaryInfo}");

            var series11 = MakeSeries(uniformVariable.ProbabilityFunctionValues);
            ...
            var normalVariable = new RandomVariable(new NormalDistribution { Mu = 0, Sigma = 1 });

            Console.WriteLine("\nНормальное распределение");
            Console.WriteLine($"{normalVariable.SummaryInfo}");

            var series21 = MakeSeries(normalVariable.ProbabilityFunctionValues);
            ...
            var exponentialVariable = new RandomVariable(new ExponentialDistribution { Lambda = 0.5 });

            Console.WriteLine("\nЭкспоненциальное распределение");
            Console.WriteLine($"{exponentialVariable.SummaryInfo}");

            var series31 = MakeSeries(exponentialVariable.ProbabilityFunctionValues);
            ...
            var uniformVar1 = new RandomVariable(new UniformDistribution { A = 0, B = 1 });
            var uniformVar2 = new RandomVariable(new UniformDistribution { A = 0, B = 1 });
            ...
            var series41 = MakeSeries(sumOfUniformVars.ProbabilityFunctionValues);
            ...
            var normalVar1 = new RandomVariable(new NormalDistribution { Mu = 0, Sigma = 1 });
            var normalVar2 = new RandomVariable(new NormalDistribution { Mu = 0, Sigma = 1 });
            ...
            var series51 = MakeSeries(productOfNormalVars.ProbabilityFunctionValues);
            ...
            var forms = MakeFormsFromCharts(new List<Chart> { chart11, chart12, chart21, chart22, chart31, chart32, chart41, chart42, chart51, chart52 });
